<div class="container-fluid">
    <livewire:admin.components.live-breadcrumb :items="[['title' => 'لیست سفارش ها', 'route' => route('admin.orders.index')], ['title' => 'ایجاد سفارش جدید']]" />
    <div class="card">
        <div class="card-body">
            <h3 class="">ایجاد سفارش</h3>
            <div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <div class="" wire:ignore>
                                                        ...
                                                        <select id="students" class="form-control select2"
                                                ...
                                                @if ($type === 'tuition')
                                                    <div class="col-md-6 mb-3">
                                                        <div class="" wire:ignore>
                                                            ...
                                                            <select id="tuitions" class="form-control select2"
                                                ...
                                                @if ($type === 'book')
                                                    <div class="col-md-6 mb-3">
                                                        <div class="" wire:ignore>
                                                            ...
                                                            <select id="books" class="form-control select2"
